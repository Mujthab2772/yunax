            ...
            return (
              ...
              >
                {showArrows && isCurrentCard && (
                  <div className="absolute inset-x-0 top-2 flex justify-between px-4 pointer-events-none">
                    <button
                      type="button"
                      aria-label="Previous testimonial"
                      className="pointer-events-auto text-2xl select-none cursor-pointer text-gray-300 hover:text-gray-400 dark:text-muted-foreground dark:hover:text-primary transition"
                      onClick={(e) => {
                        e.stopPropagation();
                        goPrev();
                      }}
